  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-12 w-full text-center">
        <motion.div {...riseVariant} className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-6 items-end">
          <motion.div {...riseVariant} className="oz-city-card p-4 sm:p-6 md:p-8 mt-5 md:mt-8">
          ...
          <motion.div {...riseVariant} transition={{ ...riseVariant.transition, delay: 0.08 }} className="oz-emerald-card oz-glow-strong p-4 sm:p-6 md:p-8 rounded-3xl md:rounded-[36px] bg-[#021f0d] text-white shadow-2xl">
          ...
          <motion.div {...riseVariant} transition={{ ...riseVariant.transition, delay: 0.16 }} className="p-4 sm:p-6 md:p-8 rounded-3xl md:rounded-[36px] bg-red-500 text-white shadow-lg relative overflow-hidden mt-5 md:mt-8">
        ...
        <motion.p {...riseVariant} transition={{ ...riseVariant.transition, delay: 0.24 }} className="mt-8 md:mt-10 text-sm md:text-lg text-[#021f0d]/50 font-bold uppercase tracking-[0.18em] md:tracking-widest">
