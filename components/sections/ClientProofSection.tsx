    ...
    >
      <div className="max-w-5xl mx-auto w-full text-center">
        <motion.div {...cardMotion} className="mb-8">
          <span className="inline-block rounded-full bg-[#006c40]/10 border border-[#006c40]/20 px-4 sm:px-5 py-2 text-[10px] sm:text-xs font-black uppercase tracking-[0.22em] sm:tracking-[0.28em] md:tracking-[0.4em] text-[#006c40] max-w-[95vw]">
