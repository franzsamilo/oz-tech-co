...
export default function ClientHeroSection() {
  return (
    ...
    >
      <div className="relative z-10 max-w-5xl mx-auto w-full flex flex-col items-center text-center oz-hero-entrance">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-black text-[#021f0d] leading-[0.92] tracking-tighter uppercase oz-gold-line max-w-5xl">
