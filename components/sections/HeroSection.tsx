...
export default function HeroSection() {
  return (
    <section
      id="hero"
      className="px-6 md:px-10 pt-6 md:pt-8 pb-10 md:pb-12 section-viewport flex flex-col items-center justify-center relative overflow-hidden bg-[#f9fafb] oz-maze-overlay oz-hero-magic oz-hero-bg"
    >
      <div className="relative z-10 max-w-4xl mx-auto w-full flex flex-col items-center text-center">
        <div className="flex items-center gap-3 mb-5 md:mb-9">
        ...
        <p className="mt-5 md:mt-8 text-sm md:text-xl text-[#021f0d]/70 max-w-2xl leading-relaxed font-medium">
