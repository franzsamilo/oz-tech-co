      ...
      <div ref={shellRef} className="relative z-[1] group overflow-hidden" style={{ borderRadius: cardRadius }}>
        ...
        >
          ...
          >
            ...
            >
              <img
                ...
                style={{
                  ...
                  transform:
                    `translateX(calc(-50% + (var(--pointer-from-left) - 0.5) * 6px)) translateZ(0) scale(${imageScale}) scaleY(calc(1 + (var(--pointer-from-top) - 0.5) * 0.02)) scaleX(calc(1 + (var(--pointer-from-left) - 0.5) * 0.01))`,
                  borderRadius: cardRadius,
                  backfaceVisibility: "hidden",
                }}
                onError={(e) => {
            ...
            {/* Details content - Name and Title at top (only when showUserInfo is true) */}
            {showUserInfo && (
              <div
            ...
            {/* Details content - Name and Title at bottom (when showUserInfo is false) */}
            {!showUserInfo && (
              <div
                className="max-h-full overflow-hidden text-center relative z-[5]"
                style={{
                ...
                >
                  <h3
                    ...
                    style={{
                      ...
                      backgroundImage:
                        "linear-gradient(to bottom, #ff6b35, #ff8555)",
                      backgroundSize: "1em 1.5em",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                      WebkitBackgroundClip: "text",
                  ...
                  <p
                    ...
                    style={{
                      ...
                      margin: "0 auto",
                      backgroundImage:
                        "linear-gradient(to bottom, #ff6b35, #ff5520)",
                      backgroundSize: "1em 1.5em",
                      WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                      WebkitBackgroundClip: "text",
